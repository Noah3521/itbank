...
//		System.out.println(ob2);
		...
		HistoryStudent ob3 = new HistoryStudent("고", 100, 99, 87, 79);
		HistoryStudent ob4 = new HistoryStudent("홍", 100, 99, 87, 79);

		Student[] arr = { ob1, ob2, ob3, ob4};

		Arrays.sort(arr, (a, b) -> a.getName().compareTo(b.getName()));	// 이름순 정렬
